...
This section's purpose is to give you enough insight into the ZUMA overlay structure and the generated files, so that you can tweak the generated virtual FPGAs to best fit your needs.
...
%\section{The ZUMA toolflow}
%
%The previous discussed model is used to configure the virtual FPGA,
%created by the ZUMA toolflow. This toolflow is as follows:
%\begin{enumerate}
%   \item take a ZUMA configuration file, which is a parametrized description
%         of the virtual FPGA. ZUMA creates a behavioral description
%         of the overlay itself, to be synthesized to an actual FPGA.
%         
%   \item take a a behavioral description of a virtual circuit in Verilog, 
%         to generate the configuration for the virtual FPGA. 
%         ZUMA builds then a bitstream for this description.
%\end{enumerate}
%With these two files, the behavioral description of the virtual FPGA and the bitstream,
%you can get the ZUMA system running on your FPGA by synthesize the description 
%on the host FPGA and then configure the virtual FPGA with the bitstream.
%The configuration of the virtual FPGA could be done by a template configurator, 
%provide in the ZUMA package.\\
%~\\
%After this schematic view, the next section describe the parameters and handling 
%of the most important tools and configurations for the ZUMA build process.
