...
def parseClusters(root):
    ...
    for clusterNode in clusterNodes:
        ...
        ##the mothod will append them to the ble list ot this cluster
...
def parseBles(clusterNode,netlistCluster):
    ...
    for bleNode in bleNodes:
        ...
        #parse the input strcuture and append the 
...
def parseFlipflop(bleNode,netlistBle):
    ...
    #there is a used flipflop. appent it to the ble object
    else:
